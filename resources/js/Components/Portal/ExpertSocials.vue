        ...
        >
            <div class="flex flex-wrap gap-4">
                <a
                    ...
                    target="_blank"
                    class="flex items-center gap-3 px-6 py-3 bg-slate-800 hover:bg-slate-700 border border-slate-700 hover:border-blue-500/50 rounded-lg transition-all group"
                >
                    <svg
                ...
                >
                    ...
                    <span class="font-medium text-white">Twitter</span>
                </a>
            ...
            <p
                v-if="!socials.linkedin && !socials.twitter && !socials.website"
