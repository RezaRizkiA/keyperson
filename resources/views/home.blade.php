            ...
            <div class="col-xl-6">
                <div class="hero-content my-5 py-3 my-xl-0">
                    <h6 class="d-flex align-items-center gap-2 fs-4 fw-semibold mb-3 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                        <i class="ti ti-rocket text-secondary fs-6"></i> konselor.id
                    </h6>
                    <h1 class="fw-bolder mb-7 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
                        Temukan & Kelola <span class="text-primary">Konselor Terbaik</span> untuk lembaga/Komunitas Anda
                    </h1>
                    <p class="fs-5 mb-5 text-dark fw-normal aos-init aos-animate" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
                        Platform appointment konselor profesional — bantu anggota Anda mendapatkan layanan terbaik, mudah dan terpercaya
                    </p>
                    <div class="d-sm-flex align-items-center gap-3 aos-init aos-animate" data-aos="fade-up" data-aos-delay="800" data-aos-duration="1000">
                        <a class="btn btn-primary px-5 py-6 btn-hover-shadow d-block mb-3 mb-sm-0" href="{{route('login')}}">Login</a>
                    </div>
                </div>
            </div>
