<div data-repeater-item class="col-12 mt-3 d-flex">
    <select name="key" class="form-select w-auto" required width="30">
    ...
    <input type="url" name="value" class="form-control ms-2" placeholder="Link profil" value="{{ $value ?? '' }}" required>
